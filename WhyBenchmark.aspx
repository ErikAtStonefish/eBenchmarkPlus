    ...
    <div class="row">
        <div class="col-sm-6 col-md-12">
            ...
            <p>
                ...
                Utility tracking and benchmarking allows us to capture data that is used to determine the building’s 
                Energy Use Index (EUI) which can help to visualize energy usage when compared to other similar buildings. 
                The initial benchmark serves as a baseline and having been documented, is now a starting point to 
                allow new energy savings opportunities to be explored.
            </p>
        </div>
    </div>
    <div class="row">
